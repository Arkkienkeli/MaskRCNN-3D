...
class MrcnnTrain:
    ...
    def Train(self):
        ...
        # Training dataset
        dataset_train = mask_rcnn_additional.NucleiDataset() #TODO
        dataset_train.initialize(pImagesAndMasks=trainImagesAndMasks, pAugmentationLevel=augmentationLevel)
        dataset_train.prepare()

        # Validation dataset
        dataset_val = mask_rcnn_additional.NucleiDataset() #TODO
        ...
        config = mask_rcnn_additional.NucleiConfig() #TODO
        ...
        mdl = model.MaskRCNN(mode="training", config=config, model_dir=os.path.dirname(outModelPath)) # TODO
